...
@Component({
  selector: 'app-list-project-progress',
  templateUrl: './list-project-progress.component.html',
  styleUrls: ['./list-project-progress.component.css']
})
export class ListProjectProgressComponent implements OnInit {
